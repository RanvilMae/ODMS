  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
	 ...
	 <div class="row">
              ...
              $query = $conn->query ("SELECT * FROM tags_admin WHERE id = $id ") or die (mysql_error());
							...
							<form method="post"  >
								...
								<thead>
									...
									<tbody>
										...
										<?php 
										require("conn.php");
										$nquery=mysqli_query($conn,"select * from `admin` WHERE department = 'TTAXD' ORDER by lname ASC");
