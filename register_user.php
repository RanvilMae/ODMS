 ...
 <h3><strong>CREATE ACCOUNT FOR USER</strong></h3>
  <hr>
	  ...
	  <div class="row"required>
		<div class="col">
		&nbsp;<input type="radio" name="position" value="Rank and File" required /> <label><strong>Rank and File</strong></label>
		</label>
		</div><br>
       <div class="col">
		<input type="radio" name="position" value="Supervisory" required /> <label><strong>Supervisory</strong></label>
		</label>
		</div><br>
       <div class="col">
		<input type="radio" name="position" value="Manager" required /> <label><strong>Manager</strong></label><br>
		</label>
		  </div>
		  </div><br>
	  ...
	  <div class="row"required>
		<div class="col">
			  ...
			  <input type="text" class="form-control" placeholder="Enter ID Number" name="tid" required /><br>
		</div>
		<div class="col">
		...
		<button type="submit" class="btn btn-primary float-right" name="signup" value="REGISTER"><i class="fas fa-user-plus"></i>
		</button>
