              ...
              echo "</tbody>";
							...
							<form method="post"  >
								...
								<thead>
									...
									<tbody>
										<br>
										<label><input type="checkbox" class="cb-selector" data-for="selector\[" /> <strong>Select All</strong></label>
										<?php 
										require("conn.php");
										$nquery=mysqli_query($conn,"select * from `users` WHERE department = 'MISD' ORDER by lname ASC");
										...
										?>
											...
											<tr>
												...
												<td>
													<?php echo $fetch['lname'] ?>, <?php echo $fetch['fname'] ?>
												</td>
							...
							<div class=" float-right">
													 <input type="submit" name="post" id="post" class="btn btn-info" value="SAVE TAG" />
													<a href="viewdata.php"><input type="button" class="btn btn-danger" name="edit" value="CANCEL"></a>
												</div>	
