											...
											<div class="modal-body">
												<table class="table">
												  ...
												  <button class="btn btn-warning btn-sm" title="CHANGE PASSWORD">
													<a style="text-decoration:none;color:white;" href="change_passc.php?id=<?php echo $fetch['id']; ?>">
														<i class="fas fa-unlock-alt"></i>
													</a>
												  </button>
												
												  <button class="btn btn-success btn-sm" title="EDIT PROFILE">
													<a style="text-decoration:none;color:white;"href="profile_cadmin.php?id=<?php echo $fetch['id']; ?>">
  ...
  <div class="album py-5 bg-light">
    <div class="container">
        ...
        <div class="row">
		 ...
		 <!-- DMS -->
          <div class="col-sm">
			<a href="chome.php" style="text-decoration: none;">
		...
		<!-- OFFICIAL DOCUMENTS -->
		<div class="col-sm">
			<a href="documents_cadmin.php" style="text-decoration: none;">
          ...
          <div class="col-sm">
		  <!-- OFFICIAL FORMS -->
			<a href="forms_cadmin.php" style="text-decoration: none;">
