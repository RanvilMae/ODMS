				...
				<div class="modal fade" id="myModal<?php echo $fetch['id']?>" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form method="POST" action="edit_file.php?id=<?php echo $id?>" enctype="multipart/form-data">
								...
								<div class="modal-body">
									...
									<input type="hidden" name="department" value="<?php echo $fetch['department']?>"/>
								<?php
			...
			<div class="modal-footer">
				...
				<a href="remarks.php?id=<?php echo $id?>" class="text-decoration-none">
					...
					<?php 
						if($department == 'MISD'){
					?>
						<a href="receiving.php?id=<?php echo $id?>" class="text-decoration-none;" >
