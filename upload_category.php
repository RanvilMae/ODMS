  ...
  <div class="jumbotron">
    <form action="upload_category.php" method="post" enctype="multipart/form-data" >
      <div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Category" id="category" name="category" required /><br>
 ...
 <div style="overflow-x:auto;">
    ...
    <tbody>
		<?php
			...
			$nquery=mysqli_query($conn,"select * from `category` ORDER BY category ASC ");
        ...
        <tr>
			...
			<td align="center">
			<button type="button" name="delete" value="C:\xampp\htdocs\ss\archive<?php echo $file['category']?>" class="btn btn-danger" title="DELETE">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			Are you sure you want to delete <strong><?php echo $file['category'] ?></strong>?
			<div class="modal-footer">
         <a href="delete_cat.php?category=<?php echo $file['category'] ?>"   class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
	...
	if (isset($_POST['sub']))
{
	...
	$query = $conn->query("SELECT * FROM `category` WHERE `category` = '$category'");
		...
		if($check == 1)
			{
				...
				{
					$conn->query ("INSERT INTO category (category)
