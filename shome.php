...
.jumbotron{
  ...
  <?php
	...
	//require("conn.php");
$id = (int) $_SESSION['log'];
		$query = $conn->query ("SELECT department FROM superadmin WHERE id = '$id' ") or die (mysqli_error());
      ...
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><strong>UPLOADED FILE/S</strong></div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><strong>ARCHIVED FILE/S</strong></div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><strong>NUMBER OF ADMIN</strong></div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">	
				<?php
				include('conn.php'); 
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><strong>NUMBER OF USER</strong></div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">	
				<?php
				//include('conn.php');  
