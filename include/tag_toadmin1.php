...
.jumbotron{
 ...
 <?php include 'navigation_admin.php';?>
			...
			<main role="main" class="container">
				<div class="jumbotron">
				    <form method="post" action="save_tag_a1.php" enctype="multipart/form-data" >
						<div id="form-group">
					...
					$department = $fetch['department'];?>			
								...
								<thead>
									...
									<tbody>
										...
										<?php 
										require("conn.php");
										$query = $conn->query ("SELECT * FROM `admin` WHERE `position` = 'SECRETARY' ORDER by `department` ASC") or die (mysqli_error());
										...
										?>
											...
											<tr>
												...
												<td>
														<strong> <?php echo $fetch['department'] ?></strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <?php echo $fetch['lname'] ?>, <?php echo $fetch['fname'] ?> 
												</td>
