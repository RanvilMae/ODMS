...
<?php include 'navigation_forms_admin.php';
...
<div class="container">
  <div class="jumbotron">
    ...
    <form action="forms_admin.php" method="post" enctype="multipart/form-data" >
      ...
      <label><strong>Date: </strong></label>
  		...
  		<button type="submit" title="UPLOAD"  name="save" class="btn btn-primary float-right">
