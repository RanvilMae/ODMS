      ...
      <li class="nav-item">
		...
		<div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="upload_dept.php"><strong>Department</strong></a>
					<a class="dropdown-item" href="upload_category.php"><strong>Category</strong></a>
					<a class="dropdown-item" href="upload_status.php"><strong>Status</strong></a>
					<!-----<a class="dropdown-item" href="upload_version.php"><strong>Version</strong></a>
					<a class="dropdown-item" href="upload_changelog.php"><strong>Change Log</strong></a>--->
                </div>
            </div>
			<div class="dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="viewusers.php"><strong>User</strong></a>
                    <a class="dropdown-item" href="viewadmins.php"><strong>Admin</strong></a>
                     <a class="dropdown-item" href="viewcentraladmins.php"><strong>Central Admin</strong></a>
                    <a class="dropdown-item" href="viewsuperadmins.php"><strong>Super Admin</strong></a>
                </div>
            </div>
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="register_user.php"><strong>User</strong></a>
                        <a class="dropdown-item" href="register_admin.php"><strong>Admin</strong></a>
                        <a class="dropdown-item" href="register_cadmin.php"><strong>Central Admin</strong></a>
                        <a class="dropdown-item" href="register_superadmin.php"><strong>Super Admin</strong></a>
                      </div>
                    </div>
				<div class="dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="searchusers.php"><strong>User</strong></a>
                    <a class="dropdown-item" href="searchadmins.php"><strong>Admin</strong></a>
                     <a class="dropdown-item" href="searchcentraladmins.php"><strong>Central Admin</strong></a>
                    <a class="dropdown-item" href="searchsuperadmins.php"><strong>Super Admin</strong></a>
                </div>
            </div>

                <a class="nav-link" href="qrprint.php"> QR PRINT</a>
                <a class="nav-link" href="filedelete.php"> FILE DELETE</a>
...
<div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer">
		  <button class="btn btn-danger"> <a href="logout.php" style="text-decoration-none;color:white;" ><i class="fas fa-sign-out-alt"></i></a></button>
            <button type="button" class="btn btn-secondary " data-dismiss="modal" onclick="redirectToPrevPage()"><i class="fas fa-window-close"></i></button>
          </div>
