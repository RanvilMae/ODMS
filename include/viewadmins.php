...
<?php include 'navigation_superadmin.php';?>
 ...
 <main role="main" class="container-fluid">
  <div class="jumbotron">
	  ...
	  <div>
        <h3><strong>VIEW ADMINS</strong></h3>
      </div>
...
<?php
			$query = $conn->query ("SELECT * FROM admin ORDER by lname ASC ") or die (mysqli_error());
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="POST" action="supdate_a.php">
...
<div class="modal fade" id="delete<?php echo $file['id']?>" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
         <a href="deletea.php?id=<?php echo $file['id'] ?>"  class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
   ...
   <div class="modal fade" id="changepass<?php echo $file['id']?>" aria-hidden="true">
	...
	<?php
     ...
     <?php
			$query = $conn->query ("SELECT * FROM admin ORDER by department ASC") or die (mysqli_error());
			while($file = mysqli_fetch_array($query)){
			?>
