					...
					<form method="post" action="delete.php" >
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            <div class="alert alert-info">
                                ...
                                <strong><i class="icon-user icon-large"></i>&nbsp;Tag Multiple Data</strong>
								&nbsp;&nbsp;Check the radion Button and click the tag button to TData 
                            </div>
                            <thead>
    ...
    <div class="modal fade" id="myModall<?php echo $fetch['id']?>" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <table class="table table-bordered">
			  ...
			  $tag = $fetch['tag'];
				...
				foreach ( $query as $fetch){
				echo "<td width='50%'>". $fetch['lname'] .", ". $fetch['fname'] ." ". $fetch['mname'] ."</td>";}
          ...
          <div class="modal-footer">
            <a href="tag_admin.php?id=<?php echo $id?>" class="text-decoration-none">
												 <button type="button" class="btn btn-success float-right" >TAG</button>
											</a>
									<button class="btn btn-danger float-right" type="button" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> CLOSE</button>
					</div>
...
<!--- TTAXD-->
 <?php
	 $id = (int) $_SESSION['login'];
		...
		$fetch = $query->fetch_array ();
		if ($fetch['department']  == 'TTAXD'){
			$nquery=mysqli_query($conn,"select * from `files` WHERE department = 'TTAXD' ORDER BY id DESC $limit");
			while($fetch = mysqli_fetch_array($nquery)){
			?>
        ...
        <tr>
          ...
          <td><?php echo $fetch['restriction']; ?></td>
			 ...
			 <td align="center">
				...
				&nbsp;
				<button type="button" name="delete" value="C:\xampp\htdocs\FMS\uploads<?php echo $file['name']?>" class="btn btn-danger">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a href="remarks.php?id=<?php echo $id?>" class="text-decoration-none">
												 <button type="button" class="btn btn-success" >REMARKS</button>
											</a>
									<button class="btn btn-danger" type="button" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> CLOSE</button>
					</div>
