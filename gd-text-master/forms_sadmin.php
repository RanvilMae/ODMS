...
<?php include 'navigation_forms_superadmin.php';?>

<div class="container">
  <div class="jumbotron">
    <form action="forms_sadmin.php" method="post" enctype="multipart/form-data" >
          <h3><strong>UPLOAD FORMS</strong></h3>
          <hr>
		...
		<button type="submit" name="save" class="btn btn-primary float-right"><i class="fas fa-file-upload"></i></button>
	</div>	  
        </form>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
	  	<button type="submit" name="save" class="btn btn-success"><i class="fas fa-file-download"></i></button>
...
<main role="main" class="container">
 ...
 <div style="overflow-x:auto;">
    ...
    <tbody>
    <?php
		 $nquery=mysqli_query($conn,"select * from `forms` ORDER BY id DESC ");
...
<td align="center">
	<div class="btn-group btn-group-justified">
		<button type="button" name="delete" title="DELETE" value="C:\xampp\htdocs\ss\forms<?php echo $file['name']?>" class="btn btn-primary">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
         <a href="delete_forms_s.php?name=<?php echo $file['name'] ?>"   class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
         <a href="download_forms.php?file_id=<?php echo $file['id'] ?>"  class="btn btn-success"><i class="fas fa-file-download"></i></a>
