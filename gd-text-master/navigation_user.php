    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
		...
		<a class="nav-link" href="user.php"> PORTAL</a>
			...
			<div class="btn-group">
			           		<a class="nav-link notification" href="view_user.php">TAGS
			           		<span class="badge">
								<?php
		...
		$tid = $file['tid'];
    $sql = "SELECT COUNT(id) FROM tagto_personnels WHERE tag = '$tid' AND track = '0'  ";  
    ...
    ?>
			    ...
			    <div class="btn-group">
					...
					<div class="dropdown-menu">
							<a class="dropdown-item" href="open_user.php"><strong>Open to All</strong></a>
							<a class="dropdown-item" href="res_user.php"><strong>Restricted</strong></a>
							<a class="dropdown-item" href="con_user.php"><strong>Confidential</strong></a>
							<a class="dropdown-item" href="out_user.php"><strong>Outgoing</strong></a>
							<a class="dropdown-item notification" href="in_user.php"><strong>Incoming</strong>
							<span class="badge">
                        		...
                        		$file = $query->fetch_array ();
                        		$tid = $file['tid'];
                        			$nquery=mysqli_query($conn,"select * from `tagto_personnels` WHERE tag = '$tid' AND track= '0'");
                        				while($get = mysqli_fetch_array($nquery)){
                        			 $id = $get['id'];
                            $sql = "SELECT COUNT(id) FROM `files` WHERE id = '$id' AND classification2 = 'Incoming'";  
                        				$rs_result = mysqli_query($conn, $sql);}  
                        				$row = mysqli_fetch_row($rs_result);  
                        				$total_records = $row[0];   
                        					echo $total_records;
							...
							<a class="dropdown-item notification" href="unread_user.php"><strong>Unread</strong>
							<span class="badge">
								<?php
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
				...
				</strong>are you sure you want to log out?
          </div>
           <div class="modal-footer">
