 ...
 <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
		...
		<a class="nav-link" href="manager.php"> PORTAL</a>
				<div class="btn-group">
			           		<a class="nav-link notification" href="view_manager.php">TAGS
			           		<span class="badge">
								<?php
    ...
    ?>
			    ...
			    <div class="btn-group">
					...
					<div class="dropdown-menu">
							<a class="dropdown-item" href="open_m.php"><strong>Open to All</strong></a>
							<a class="dropdown-item" href="res_m.php"><strong>Restricted</strong></a>
							<a class="dropdown-item" href="con_m.php"><strong>Confidential</strong></a>
							<a class="dropdown-item" href="out_m.php"><strong>Outgoing</strong></a>
							<a class="dropdown-item notification" href="unread_m.php"><strong>Unread</strong>
							<span class="badge">
								<?php
    ...
    ?>
		...
		<a class="nav-link" href="search_manager.php"> SEARCH</a>
     </li>
    </ul>
												...
												<tr>
												 ...
												 <div class="modal-footer" >
												  <button class="btn btn-warning btn-sm" title="CHANGE PASSWORD">
													  <a style="text-decoration:none;color:white;" href="change_pass_m.php?id=<?php echo $fetch['id']; ?>">
														<i class="fas fa-unlock-alt"></i>
													  </a>
												  </button>
												
												  <button class="btn btn-success btn-sm" title="EDIT PROFILE">
													<a style="text-decoration:none;color:white;" href="profile_m.php?id=<?php echo $fetch['id']; ?>">
