...
$(function() {
 ...
 <div>
  ...
  <button type="submit" name="save" title="SEARCH" class="btn btn-primary" ><i class="fas fa-search"></i></button>
</div>
<br>
<br>
  <div style="overflow-x:auto;">
	...
	<?php
		...
		if(isset($_POST['search'])){
					...
					$search=$_POST['search'];
					$query="select * from forms where name like '%".$search."%' || id like '%".$search."%' ";
