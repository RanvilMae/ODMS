...
<?php
	...
	$query=mysqli_query($conn,"select count(id) from `files` WHERE restriction = 'Open to All' AND id = '$id'");
	...
	$nquery=mysqli_query($conn,"select * from `files` WHERE restriction = 'Open to All' AND id = '$id' ORDER BY id DESC $limit");
