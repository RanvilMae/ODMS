...
if(isset($_POST['search'])){
	$search=$_POST['search'];
	$query="select * from superadmin WHERE tid like '%".$search."%' || fname like '%".$search."%' || lname like '%".$search."%' || mname like '%".$search."%' ||  email like '%".$search."%' ||  date like '%".$search."%' || department like '%".$search."%'";
   ...
   <tr>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="POST" action="updatesuperadmins.php">
		...
		<div class="row"required>
			...
			<input class="form-control" type="text" name="department" 
			 value="<?php echo $file['department'];?>" /><br>
			 
			<label for="position"><strong>POSITION:</strong></label>
			<input class="form-control " type="text" name="position" 
			 value="<?php echo $file['position'];?>" /><br>
