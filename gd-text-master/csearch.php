...
if(isset($_POST['search'])){
	...
	$query="select * from files WHERE 
		...
		OR for_specific like '%".$search."%' AND department = '$department'
		OR fromw like '%".$search."%' AND department = '$department'
		OR from_specific like '%".$search."%' AND department = '$department'
  ...
  while($file= mysqli_fetch_assoc($result)) { 
   ...
   ?>
  <tr>
			<td><?php echo $file['docu_id']; ?></td>
			<td><?php echo $file['fromw']; ?><br><?php echo $file['from_specific']; ?></td>
			<td><?php echo $file['category']; ?></td>
			<td><?php echo $file['subject']; ?></td>
			<td><?php echo $file['date']; ?></td>
			<td><?php echo $file['restriction']; ?></td>

			<td align="center">
				<div class="btn-group btn-group-justified">
					<button type="button" class="btn btn-primary" title="STATUS">
						<a data-toggle="modal" data-target="#myModall<?php echo $file['id']?>" style="text-decoration-none;color:white;">
					...
					<button type="button" class="btn btn-primary" title="PREVIEW">
						<a href="uploads/<?php echo $file['name']?>" target="_blank" class="text-decoration-none" style="color:white;">
...
<p><font face="verdana" color="green" class="float-left"><strong><?php echo $subject?></strong></font></p>
          ...
          <div class="modal-footer">
				<a href="download_status.php?id=<?php echo $id?>" target="_blank" style="text-decoration-none;color:white;>" class="text-decoration-none">
