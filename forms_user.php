...
<?php include 'navigation_forms_user.php';?>
...
$(function() {
 ...
 <main role="main" class="container-fluid">
  <div class="jumbotron">
  <div>
  <h3><strong>TIEZA OFFICIAL FORMS</strong></h3>
 </div><hr>
        ...
        <tr>
          ...
          <td><?php echo $file['date']; ?></td>
			...
			<button type="button" class="btn btn-primary" title="PREVIEW">
				<a href="forms/<?php echo $file['name']?>" target="_blank" class="text-decoration-none" style="color:white;">
 ...
 <?php
		...
		if ($fetch['department']  == 'TTAXD'){
		 $nquery=mysqli_query($conn,"select * from `forms` WHERE department = 'TTAXD' ORDER BY id DESC ");
		while($file = mysqli_fetch_array($nquery)){
	?>
        <tr>
          ...
          <td><?php echo $file['date']; ?></td>
			...
			<td align="center">	
			<button type="button" class="btn btn-success"><a href="forms/<?php echo $file['name']?>" target="_blank" class="text-decoration-none" style="color:white;">PREVIEW</a> </button>
