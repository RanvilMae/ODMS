...
.jumbotron{
 ...
 <?php include 'navigation_admin.php';?>
			...
			<main role="main" class="container">
				<div class="jumbotron">
				    <form method="post" action="save_tag_a.php" enctype="multipart/form-data" >
						<div id="form-group">
					...
					$department = $fetch['department'];?>			
								...
								<thead>
									...
									<tbody>
										...
										<?php 
										require("conn.php");
										$query = $conn->query ("SELECT * FROM department WHERE classification = 'DEPARTMENT' ORDER by department ASC") or die (mysqli_error());
                    					while($fetch = mysqli_fetch_array($query)){
                    					$department = $fetch['department'];
										$nquery=mysqli_query($conn,"select * from `admin` WHERE `department` = '$department' ");
										...
										?>
											...
											<tr>
												...
												<td>
														<strong> <?php echo $fetch['department'] ?></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-
