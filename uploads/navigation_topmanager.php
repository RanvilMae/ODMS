  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
		...
		<a class="nav-link" href="topmanager.php"> PORTAL</a>
			<div class="btn-group">
				<a class="nav-link" href="home_topmanager.php"> HOME</a>
					<?php
					 	$id = (int) $_SESSION['tm'];
			    ...
			    ?>
				<a class="nav-link notification" href="view_topmanager.php"> <?php echo "$department";?> FILES</a>
				<a class="nav-link notification" href="in_tm.php">INCOMING
							<span class="badge">
								<?php
									 $id = (int) $_SESSION['tm'];
										$query = $conn->query ("SELECT * FROM `users` WHERE id = '$id' ORDER BY date DESC ") or die (mysqli_error());
        ...
        <div class="modal-dialog modal-lg">
			...
			<div class=" text-monospace float-right dropdown text-decoration-none " style="color:WHITE"><?php include ("clock.php"); ?>
					<a class="text-monospace " href="#" data-toggle="modal" data-target="#exampleModal" style="color:WHITE" >
						<i class="fas fa-user"></i> <?php echo $fetch['lname']; ?>, <?php echo $fetch['fname']; ?> <?php echo $fetch['mname']; ?>
					</a> 
						...
						<div style="overflow-x:auto;">
							...
							<div class="modal-footer" >
								<button class="btn btn-warning btn-sm" title="CHANGE PASSWORD">
									<a style="text-decoration:none;color:white;" href="change_pass_tm.php?id=<?php echo $fetch['id']; ?>">
										<i class="fas fa-unlock-alt"></i>
									</a>
								</button>

								<button class="btn btn-success btn-sm" title="EDIT PROFILE">
									<a style="text-decoration:none;color:white;" href="profile_tm.php?id=<?php echo $fetch['id']; ?>">
