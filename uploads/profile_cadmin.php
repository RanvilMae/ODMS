...
<?php include 'navigation_cadmin.php';?>
							...
							<?php
								...
								$query = $conn->query ("SELECT * FROM centraladmin WHERE id = '$id' ") or die (mysql_error());
			...
			<main role="main" class="container">
				  <div class="jumbotron">
					<form method="post" action="update_info_c.php" enctype="multipart/form-data" >
						<div id="form-group">
						<h3><strong>EDIT PROFILE</strong></h3>
							 <hr>
								...
								<button type="button" name="cancel" title="CANCEL"  class="btn btn-danger ">	
									<a style="text-decoration:none;color:WHITE;" href="centraladmin.php">
