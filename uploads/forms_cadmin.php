...
<?php include 'navigation_forms_cadmin.php';?>


<div class="container">
  <div class="jumbotron">
    <form action="forms_cadmin.php" method="post" enctype="multipart/form-data" >
		...
		<button type="submit" title="UPLOAD"  name="save" class="btn btn-primary float-right"><i class="fas fa-upload"></i></button>
	</div>	  
        </form>
...
<td align="center">
  <div class="btn-group btn-group-justified">
	...
	<button type="button" name="fileToRemove" class="btn btn-primary" title="DOWNLOAD">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
         <a href="delete_forms.php?name=<?php echo $file['name'] ?>"   class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
						 <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-window-close"></i></button>
					</div>
      </div>
    </div>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
         <a href="download_forms.php?id=<?php echo $file['id'] ?>"  class="btn btn-success"><i class="fas fa-download"></i></a>
