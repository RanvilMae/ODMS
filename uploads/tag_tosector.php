...
<?php include 'navigation_admin.php';?>
			...
			<main role="main" class="container">
				<div class="jumbotron">
					<form method="post" action="save_tagsector.php" enctype="multipart/form-data" >
						<div id="form-group">
						<h3><strong>SECTOR TAGGING</strong></h3>
							 <hr>
					...
					?>
								...
								<thead>
									...
									<tbody>
										...
										<?php 
										require("conn.php");
										$nquery=mysqli_query($conn,"SELECT * FROM department WHERE classification = 'SECTOR'");
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js" integrity="sha384-B0UglyR+jN6CkvvICOB2joaf5I4l3gm9GU6Hc1og6Ls7i6U/mkkaduKaBhlAXv9k" crossorigin="anonymous"></script>
	...
	$(document).ready(function () {
		$(".cb-selector").click(function () {
			...
			{
				$("[name*='selector']").prop("checked",false);
			}
		});
	});
	</script>	
