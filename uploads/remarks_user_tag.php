  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
			...
			<main role="main" class="container">
				<div class="jumbotron">
					<form method="post" action="update_remarks_user_tag.php" enctype="multipart/form-data" >
						<div id="form-group">
    ...
    <div class="row">
							...
							<div class=" float-right">
													<button name="save" class="btn btn-primary"><i class="fas fa-download"></i></button>
													<button class="btn btn-danger"><a href="viewdata.php"></a><i class="fas fa-window-close"></i></button>
												</div>	
