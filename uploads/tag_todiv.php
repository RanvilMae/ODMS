								...
								<thead>
									...
									<tbody>
										...
										$department = $fetch['department'];
										 $query = $conn->query ("SELECT * FROM department WHERE division = '$department' ") or die (mysql_error());
                                          foreach ( $query as $get){
										$department = $get['department'];
										    
										 $nquery = $conn->query ("SELECT * FROM users WHERE division = '1' AND department = '$department' ") or die (mysql_error());
