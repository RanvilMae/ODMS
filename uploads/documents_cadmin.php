...
<?php include 'navigation_documents_cadmin.php';?>


<div class="container">
  <div class="jumbotron">
    <form action="documents_cadmin.php" method="post" enctype="multipart/form-data" >
  ...
  <div class="btn-group btn-group-justified">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
         <a href="download_documents.php?id=<?php echo $file['id'] ?>"  class="btn btn-success"><i class="fas fa-file-download"></i></a>
