...
$(function() {
 ...
 <main role="main" class="container-fluid">
  <div class="jumbotron">
   ...
   <h3><strong>SEARCH CENTRAL ADMINS</strong></h3>
 <hr>
...
if(isset($_POST['search'])){
	$search=$_POST['search'];
	$query="select * from centraladmin WHERE tid like '%".$search."%' || fname like '%".$search."%' || lname like '%".$search."%' || mname like '%".$search."%' ||  email like '%".$search."%' ||  date like '%".$search."%' || department like '%".$search."%'";
