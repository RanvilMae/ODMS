  ...
  <div class="album py-5 bg-light">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm">
          <a href="home_manager.php" style="text-decoration: none;">
       ...
       <a href="http://attendance.tieza.gov.ph" target="_blank" style="text-decoration: none;">
        ...
        <div class="row">
          <div class="col-sm">
          <a href="documents_manager.php" style="text-decoration: none;">
          ...
          <div class="col-sm">
       <a href="forms_manager.php" style="text-decoration: none;">
