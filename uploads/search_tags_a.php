...
if(isset($_POST['search'])){
				   ...
				   $query = "SELECT * FROM tags WHERE tag = '$tid'";
					$resultset = mysqli_query($conn, $query) or die("database error:". mysqli_error($conn));
				while($fetch = mysqli_fetch_assoc($resultset)) {
					$id = $fetch['id'];
			$search=$_POST['search'];
			$query="select * from files WHERE 
			`id` = '$id'  AND docu_id like '%".$search."%' OR
			`id` = '$id'  AND name like '%".$search."%' OR
			`id` = '$id'  AND forw like '%".$search."%' OR
			`id` = '$id'  AND fromw like '%".$search."%' OR
			`id` = '$id'  AND subject like '%".$search."%' OR
			`id` = '$id'  AND date like '%".$search."%' OR
			`id` = '$id'  AND classification like '%".$search."%' OR
			`id` = '$id'  AND category like '%".$search."%' OR
			`id` = '$id'  AND restriction like '%".$search."%' ORDER BY id DESC";
