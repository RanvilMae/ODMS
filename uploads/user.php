  ...
  <div class="album py-5 bg-light">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm">
          <a href="home_user.php" style="text-decoration: none;">
		   ...
		   <a href="http://oas.tieza.gov.ph" target="_blank" style="text-decoration: none;">
            <div class="card text-white mb-3" style="background-color: #607D8B;">
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="h5 font-weight text-uppercase mb-1"><strong>TIME KEEPING</strong></div>
        ...
        <div class="row">
          <div class="col-sm">
          <a href="documents_user.php" style="text-decoration: none;">
          ...
          <div class="col-sm">
		   <a href="forms_user.php" style="text-decoration: none;">
