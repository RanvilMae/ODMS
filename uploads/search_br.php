...
if(isset($_POST['search'])){
	$search=$_POST['search'];
	$query="select * from board_resolution WHERE 
			br_id like '%".$search."%' 
		OR name like '%".$search."%' 
			...
			<td align="center">
				<div class="btn-group btn-group-justified">
					...
					<button type="button" class="btn btn-primary" title="PREVIEW">
						<a href="board resolutions/<?php echo $file['name']?>" target="_blank" class="text-decoration-none" style="color:white;">
					...
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<a href="deleteData_search_br.php?name=<?php echo $file['name'] ?>"  class="btn btn-primary"><i class="fas fa-trash-alt"></i></a>
...
<p><font face="verdana" color="green" class="float-left"><strong><?php echo $subject?></strong></font></p>
          ...
          <div class="modal-footer">
				...
				<a href="remarks.php?id=<?php echo $id?>" style="text-decoration-none;color:white;>" class="text-decoration-none">
