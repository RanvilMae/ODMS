  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
		...
		<a class="nav-link" href="centraladmin.php"> PORTAL</a>
		
		<a class="nav-link" href="chome.php"> HOME</a>
		<a class="nav-link" href="cupload.php"> UPLOAD</a>
		<a class="nav-link" href="ca_viewdata.php"> VIEW</a>
		<a class="nav-link" href="csearch.php"> SEARCH</a>
									...
									?>				
											...
											<div class="modal-body">
												...
												<tr>
												  ...
												  <button class="btn btn-warning btn-sm"><a style="text-decoration:none;color:WHITE;" href="change_passc.php?id=<?php echo $fetch['id']; ?>"><i class="fas fa-unlock-alt"></i></a></button>
												
												  <button class="btn btn-success btn-sm"><a style="text-decoration:none;color:WHITE;" href="profile_cadmin.php?id=<?php echo $fetch['id']; ?>"><i class="fas fa-user-edit"></i></a></button>
