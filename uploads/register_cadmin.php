...
<main role="main" class="container">
  <div class="jumbotron">
    <form action="register_cadmin.php" method="post" enctype="multipart/form-data" >
	...
	<div class="row"required>
	  ...
	  <div class="row"required>
		<div class="col">
			  ...
			  <input type="text" class="form-control" placeholder="Enter ID Number" name="tid" value="CA-" /><br>
		</div>
	...
	if (isset($_POST['signup']))
{
	...
	$query = $conn->query("SELECT * FROM `centraladmin` WHERE `tid` = '$tid'");
		...
		if($check == 1)
			{
				...
				{
					$conn->query ("INSERT INTO centraladmin ( tid, fname, mname, lname, email, password, date, department )
					VALUES ('$tid', '$fname', '$mname',  '$lname', '$email', '$password', '$date', '$department')") or die(mysqli_error());	
					echo "<script>alert('CENTRAL ADMIN SAVED!')</script>"; 
					exit(); 
				}				
