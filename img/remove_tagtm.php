  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
			...
			<main role="main" class="container">
				<div class="jumbotron">
					<form method="post" action="save_tag.php" enctype="multipart/form-data" >
						<div id="form-group">
						<h3><strong>REMOVE TAGS</strong></h3>
						<p><font face="verdana" color="green" class="float-left"><strong><?php echo $subject?></strong></font></p><br>
							 <hr>
	 ...
	 <div class="row">
         ...
         <input type="hidden" name="id" value="<?php echo $fetch['id'];?>"/>
			  ...
			  $nquery = $conn->query ("SELECT * FROM tags WHERE tag = '$tag' AND id = $id ") or die (mysqli_error());
				foreach ( $nquery as $fetch){
				$tagid = $fetch['primary_id'];
				...
				<td ><?php echo $fetch['lname'] .", ". $fetch['fname'] ." ". $fetch['mname']; }?></td>
				 <td align="center">
					...
					<button type="button" name="delete" class="btn btn-danger" title="DELETE">
						<a data-toggle="modal" data-target="#delete<?php echo $tagid;?>" style="text-decoration-none;color:white;">
	  ...
	  <!----MODAL FOR DELETE-->
	   <div class="modal fade" id="delete<?php echo $tagid;?>" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			Are you sure you want to delete <strong><?php echo $fetch['fname'] ?></strong> in your taglist?
			<div class="modal-footer">
			
         <a href="deletetagtm.php?tagid=<?php echo $tagid;?>"   class="btn btn-danger">Delete</a>
			  ...
			  <?php } ?>
							...
							<div class=" float-right">
													<a href="viewdata.php"><input type="button" class="btn btn-primary" name="edit" value="CANCEL"></a>
												</div>	
