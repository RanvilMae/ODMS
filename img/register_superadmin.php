...
<main role="main" class="container">
  <div class="jumbotron">
    <form action="register_superadmin.php" method="post" enctype="multipart/form-data" >
      <div class="form-group">
 <h3><strong>CREATE ACCOUNT FOR SUPER ADMIN</strong></h3>
  <hr>
	...
	<div class="row"required>
	  ...
	  <div class="row"required>
		<div class="col">
			  ...
			  <input type="text" class="form-control" placeholder="Enter ID Number" name="tid" value="SA-" /><br>
		</div>
	...
	if (isset($_POST['signup']))
{
	...
	$query = $conn->query("SELECT * FROM `superadmin` WHERE `tid` = '$tid'");
		...
		if($check == 1)
			{
				...
				{
					$conn->query ("INSERT INTO superadmin ( tid, fname, mname, lname, email, password, date, department )
					VALUES ('$tid', '$fname', '$mname',  '$lname', '$email', '$password', '$date', '$department')") or die(mysqli_error());	
					echo "<script>alert('SUPER ADMIN SAVED!')</script>"; 
					exit(); 
				}				
