  ...
  <div class="album py-5 bg-light">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm">
          <a href="home_topmanager.php" style="text-decoration: none;">
          ...
          <div class="col-sm">
       <a href="https://attendance.tieza.gov.ph" target="_blank" style="text-decoration: none;">
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    ...
                    <div class="font-weight mb-1">ATTENDANCE CHECKING</br></br></div>
                  </div>
                  <div class="col-auto">
        ...
        <div class="row">
          <div class="col-sm">
          <a href="documents_topmanager.php" style="text-decoration: none;">
          ...
          <div class="col-sm">
          <a href="forms_topmanager.php" style="text-decoration: none;">
...
<footer class="footer">
    <div class="inner">
    <strong>Copyright &copy; 2019. All rights reserved.<br>Management Information Systems Department.<br></strong>
