  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
			...
			<main role="main" class="container">
				  <div class="jumbotron">
					<form method="post" action="update_infotm.php" enctype="multipart/form-data" >
							...
							<div class="row"required>
								...
								<div class=" float-right">
										<button name="edit" title="SAVE CHANGES" class="btn btn-success">
										<i class="fas fa-save"></i>
									</button>
									<button type="button" name="cancel" title="CANCEL"  class="btn btn-danger ">	
										<a style="text-decoration:none;color:WHITE;" href="topmanager.php">
