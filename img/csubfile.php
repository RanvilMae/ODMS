    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
			...
			<main role="main" class="container">
				<div class="jumbotron">
					<form method="post" action="save_sub.php" enctype="multipart/form-data" >
						<div id="form-group">
							<hr>
    ...
    <div class="row">
							<div class="col-md-5">
								...
								$department = $gett['department'];?>
												...
												<input type="text" class="form-control" placeholder="Remarks" name="remarks" required /><br>
						...
						<h3><strong>SUB DOCUMENTS</strong></h3>
									...
									<tbody>
												...
												?>
												<td style="border: 2px solid black;"><?php echo $fetch['sub_docu']; ?></td>
												
												<td style="border: 2px solid black;"><?php echo $fetch['pages']; ?></td>
												...
												<td style="border: 2px solid black;"><?php echo $fetch['action']; ?></td>
												</tr>	
												<?php } ?> 
							...
							<div class=" float-right">
													...
													<a href="ca_viewdata.php" class="text-decoration-none">
