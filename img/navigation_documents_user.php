  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
		...
		<a class="nav-link" href="documents_user.php">DOCUMENTS</a>
		<a class="nav-link" href="documents_usersearch.php"> SEARCH</a>
  ...
  <div id="cl" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
			...
			<div class=" text-monospace float-right dropdown text-decoration-none " style="color:WHITE"><?php include ("clock.php"); ?>
					<a class="text-monospace " href="#" data-toggle="modal" data-target="#exampleModal" style="color:WHITE" >
						<i class="fas fa-user"></i> 
						<?php echo $fetch['lname']; ?>, <?php echo $fetch['fname']; ?> <?php echo $fetch['mname']; ?>
					</a> 
								...
								<table class="table">
									...
									<th scope="col"><?php echo $fetch['date'];?><br>
									  ...
									  <button class="btn btn-warning btn-sm" title="CHANGE PASSWORD">
									  	<a style="text-decoration:none;color:white;" href="change_pass_user.php?id=<?php echo $fetch['id']; ?>">	<i class="fas fa-unlock-alt"></i>
									  	</a>
									  </button>
									
									  <button class="btn btn-success btn-sm" title="EDIT PROFILE"><a style="text-decoration:none;color:white;" href="profile_user.php?id=<?php echo $fetch['id']; ?>"><i class="fas fa-user-edit"></i></a></button>
