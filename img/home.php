  ...
  function drawChart(){  
    ...
    chart.draw(data, options);  
      ...
      $id = (int) $_SESSION['login'];
		...
		$get = $query->fetch_array ();
		$department = $get['department'];
	$sql = "SELECT status, count(*) as number FROM remarks WHERE department = '$department' GROUP BY status";
	$query = $conn->query($sql);
...
<script type="text/javascript">  
  ...
  function drawChart(){  
    ...
    var options = {  
              title: 'Type of Status Percentage',  
              //is3D:true,  
              pieHole: 0.2
          };  
...
<div class="container-fluid">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase" mb-1 class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">NUMBER OF ADMIN/S</div>
                    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                              <h3 class="modal-title">REGISTERED ADMIN/S</h3>
                            </div>
                                ...
                                <table class="table table-bordered">
                                  <thead>
                                    <tr>
                    				  ...
                    				  <th class="tablecell">USER LEVEL</th>
                                    </tr>
                                  </thead>
                    
                                   <?php 
                                  $tid = $file['tid'];
                                  $nquery = $conn->query("SELECT * FROM admin WHERE department = '$department' ") or die (mysql_error());
                                  ...
                                  echo "<tbody>";
                                  echo "<tr>";
                    			  echo "<td >". $fetch['lname'] .', '. $fetch['fname'] .' '. $fetch['mname'] ."</td>";
                                  echo "<td>". $fetch['position'] ."</td>";
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
                   <div class="text-xs font-weight-bold text-warning text-uppercase mb-1" data-toggle="modal" data-target="#users" ">NUMBER OF USER/S</div>
                   
                    <div class="modal fade bd-example-modal-lg" id="users" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                              <h3 class="modal-title">REGISTERED USER/S</h3>
                            </div>
                            <div class="modal-body">
                                <table class="table table-bordered">
                                  <thead>
                                   ...
                                   <?php 
                                  $tid = $file['tid'];
                                  $nquery = $conn->query("SELECT * FROM users WHERE department = '$department'") or die (mysql_error());
    ...
    <!-- Area Chart -->
      <div class="card shadow mb-3">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Number of Uploaded Files per Month</h6>
        ...
        <!-- Card Body -->
        <div class="card-body">
         <div id="curve_chart" style="width: 100%; height: 150px"></div>
        </div>
      </div>
  ...
  <div style="container-fluid" class="mx-auto" >
      <div class="card shadow mb-3">
        ...
        <!-- Card Body -->
      <div id="piechartt" style="height:350px; width: 100%;"></div>
    </div> 
        </div>
      </div>
    </div>
