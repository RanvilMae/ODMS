    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
			...
			<main role="main" class="container">
				<div class="jumbotron">
					<form method="post" action="update_remarks1.php" enctype="multipart/form-data" >
						<div id="form-group">
							<hr>
							...
							<div class="col-md-5">
										...
										<!--		<select input name="department" class="form-control" id="department" required>	
												...
												$result = $conn->query($query);	
													...
													echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><input  id ='status' name='status'  type='radio' value='" . $row['status'] ."'>" . $row['status'] ."</input></strong>";
													echo "<br>";
													}
												?>
												</select><br> -->
